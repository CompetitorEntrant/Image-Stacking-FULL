...
#Description: This script finds all the Mg II absorbers image files by cross checking the Mg II catalog with the DR7 QSO catalog for RA and DEC coordinates. 
    ...
    try:
        ...
        if mgtable['ZABS'][j] >= 0.37 and mgtable['ZABS'][j] < 0.55:
            ...
            for k in range(1, 105784):
                ...
                #print(k)
                if abs(float(temp[1]) - mgtable['RA'][j]) < 0.0001:
                    print(k)
