...
#Description: First version of qsocut that manually calculates the image physical coordinates from the RA and DEC by using the reference pixel RA, DEC, x, y values and the unit parameters given in the header file of the field image fits file.
